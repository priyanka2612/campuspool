...
class ConsultantsControllerTest < ActionController::TestCase
  ...
  test "should create consultant" do
    assert_difference('Consultant.count') do
      post :create, consultant: { Address: @consultant.Address, Contact_no: @consultant.Contact_no, Name: @consultant.Name }
    end
  ...
  test "should update consultant" do
    patch :update, id: @consultant, consultant: { Address: @consultant.Address, Contact_no: @consultant.Contact_no, Name: @consultant.Name }
    assert_redirected_to consultant_path(assigns(:consultant))
  end
